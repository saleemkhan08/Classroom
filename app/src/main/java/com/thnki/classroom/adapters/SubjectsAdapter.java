...
import com.thnki.classroom.dialogs.AddOrEditClassDialogFragment;
...
public class SubjectsAdapter extends FirebaseRecyclerAdapter<Subjects, SubjectViewHolder>
{
    ...
    protected void populateViewHolder(final SubjectViewHolder viewHolder, final Subjects model, int position)
    {
        ...
        viewHolder.optionsIconContainer.setVisibility(isSelectionEnabled ? View.GONE : View.VISIBLE);
    ...
    {
        AddSubjectsDialogFragment fragment = AddSubjectsDialogFragment.getInstance(subject);
        fragment.show(mActivity.getSupportFragmentManager(), AddOrEditClassDialogFragment.TAG);
    }
}